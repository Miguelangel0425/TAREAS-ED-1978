...
void CircularList::handleMenu(Nodo*& head, const string& institution) {
    ...
    menu_circular.addOption("Encriptar los datos");
    menu_circular.addOption("Desencriptar los datos");
    ...
    while (true) {
        ...
        switch (option) {
            ...
            case 4:
                {
                int clave = validation.ingresarInt("Ingrese la clave para encriptar");
                encrypt(clave);
                cout << "Datos encriptados con éxito." << endl;
                break;
            }
            case 5: { // Desencriptar datos
                int clave = validation.ingresarInt("Ingrese la clave para desencriptar");
                decrypt(clave);
                cout << "Datos desencriptados con éxito." << endl;
                break;
            }
            case 6: // Salir
